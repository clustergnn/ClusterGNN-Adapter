...
if __name__ == '__main__':
    ...
    parser.add_argument('--clusterGNN', type=str2bool, default=True, help='whether to use clusterGNN in iTransformer')
    parser.add_argument('--num_clusters', type=int, default=64, help='number of clusters for clusterGNN') # only applicable for iTransformer with clusterGNN
